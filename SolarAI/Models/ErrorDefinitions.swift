...
/// All error/warning bit definitions from the alarm description spreadsheet
enum ErrorDefinitions {

    // MARK: - Error Message 1 (控制码 25261)
    ...
    // MARK: - Error Message 2 (控制码 25262)
    ...
    // MARK: - Error Message 3 (控制码 25263) — Parallel related
    ...
    // MARK: - Warning Message 1 (控制码 25265)
    ...
    // MARK: - Warning Message 2 (placeholder for expansion)

    static let warn2: [Int: FaultDefinition] = [:]

    // MARK: - Charger Error (控制码 15213/16213)
    ...
    // MARK: - Charger Warning (控制码 15214/16214)
